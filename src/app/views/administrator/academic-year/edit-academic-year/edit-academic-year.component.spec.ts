...
import { EditAcademicYearComponent } from './edit-academic-year.component';
...
describe('EditAcademicYearComponent', () => {
  let component: EditAcademicYearComponent;
  let fixture: ComponentFixture<EditAcademicYearComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ EditAcademicYearComponent ],
      imports: [
        RouterTestingModule,
        HttpClientTestingModule ,
        FormsModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EditAcademicYearComponent);
